...
1. Start the API and open the home page. Point out whether the health badge reports LLM or deterministic mode.
...
7. Finish with the 120-case report and clarify the query-only boundary: no login, booking, payment, or invented availability.
