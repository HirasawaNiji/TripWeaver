...
The optional OpenAI interpreter uses the Responses API Structured Outputs parser with a Pydantic `RevisionIntent`. The deterministic parser remains the no-key default and all resulting plans still pass through the same planner and Validator.
